...
class CourseSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_subject" do
    assert_difference('CourseSubject.count') do
      post course_subjects_url, params: { course_subject: { course_id: @course_subject.course_id, location_id: @course_subject.location_id, programme_id: @course_subject.programme_id, semester_id: @course_subject.semester_id, subject_id: @course_subject.subject_id } }
    end
  ...
  test "should update course_subject" do
    patch course_subject_url(@course_subject), params: { course_subject: { course_id: @course_subject.course_id, location_id: @course_subject.location_id, programme_id: @course_subject.programme_id, semester_id: @course_subject.semester_id, subject_id: @course_subject.subject_id } }
