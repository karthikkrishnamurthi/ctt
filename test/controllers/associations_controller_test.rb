...
class AssociationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create association" do
    assert_difference('Association.count') do
      post associations_url, params: { association: { course_id: @association.course_id, course_type_id: @association.course_type_id, location_id: @association.location_id, programme_id: @association.programme_id, semester_id: @association.semester_id, subject_id: @association.subject_id, subject_type_id: @association.subject_type_id } }
    end
  ...
  test "should update association" do
    patch association_url(@association), params: { association: { course_id: @association.course_id, course_type_id: @association.course_type_id, location_id: @association.location_id, programme_id: @association.programme_id, semester_id: @association.semester_id, subject_id: @association.subject_id, subject_type_id: @association.subject_type_id } }
